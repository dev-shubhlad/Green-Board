...
import { InstructorCourseList } from "../../instructorList/instructorCourseList/InstructorCourseList";
import { Attendance } from "../../instructorList/Attendance/Attendance";

class InstructorVerticalTab extends PureComponent {
  state = { activeIndex: 0 };
      ...
      <div style={{ width: "100%" }}>
        <div className="row">
          ...
          <div className="h-100 flex-fixed-right-width-item">
            {activeIndex === 0 && <InstructorCourseList />}
...
export default InstructorVerticalTab;
